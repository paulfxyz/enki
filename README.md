...
| | |
|---|---|
| 📜 **[The Manifesto](MANIFESTO.md)** | A letter on the state of intelligence — nine articles, one annex, **79 references**. The founding document; everything else derives from it. |
...
| Path | Purpose |
|---|---|
| [`MANIFESTO.md`](MANIFESTO.md) | The full manifesto letter — nine articles, the standards annex, all 79 references |
